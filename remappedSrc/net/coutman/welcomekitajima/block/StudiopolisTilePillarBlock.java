...
public class StudiopolisTilePillarBlock extends Block {
	...
	public static void clientInit() {
		BlockRenderLayerMap.INSTANCE.putBlock(WelcomekitajimaModBlocks.STUDIOPOLIS_TILE_PILLAR, RenderLayer.getSolid());
	}
}

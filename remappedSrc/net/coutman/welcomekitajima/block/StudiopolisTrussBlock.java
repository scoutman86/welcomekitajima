...
public class StudiopolisTrussBlock extends Block {
	public static AbstractBlock.Settings PROPERTIES = AbstractBlock.Settings.create().requiresTool().sounds(BlockSoundGroup.METAL).strength(1.8f, 10f).requiresTool();
	...
	public static void clientInit() {
		BlockRenderLayerMap.INSTANCE.putBlock(WelcomekitajimaModBlocks.STUDIOPOLIS_TRUSS, RenderLayer.getCutout());
	}
}

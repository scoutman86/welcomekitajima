...
import net.coutman.welcomekitajima.procedures.TeleportToAndFromStreetSEKAIProcedure;
...
public class ReadySteadyItem extends RecordItem {
	public ReadySteadyItem() {
		super(0, // comparator output
				WelcomekitajimaModSounds.RECORD_READY_STEADY,
	...
	public InteractionResultHolder<ItemStack> use(Level world, Player entity, InteractionHand hand) {
		...
		TeleportToAndFromStreetSEKAIProcedure.execute(entity, ar.getObject());
		return ar;
	}
}

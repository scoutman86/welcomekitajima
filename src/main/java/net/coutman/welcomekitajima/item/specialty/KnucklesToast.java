...
public class KnucklesToast extends Item {
    public KnucklesToast() {
            super(
    ...
    public void appendHoverText(ItemStack itemStack, @Nullable Level level, List<Component> list, TooltipFlag tooltipFlag) {
        list.add(Component.translatable("itemTooltip.welcomekitajima.knuckle_sandwich").withStyle(ChatFormatting.GRAY));
    }
}

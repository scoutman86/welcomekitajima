...
public class DiscEnterNoiseProcedure {
	public static void execute(WorldAccess world, double x, double y, double z) {
		if (world instanceof World _level) {
			if (!_level.isClient()) {
				_level.playSound(null, BlockPos.ofFloored(x, y, z), WelcomekitajimaModSounds.BLOCK_DRIVE_CLOSE, SoundCategory.BLOCKS, 1, 1);
			} else {
				_level.playSound(x, y, z, WelcomekitajimaModSounds.BLOCK_DRIVE_CLOSE, SoundCategory.BLOCKS, 1, 1, false);
			}
		}
	}
}

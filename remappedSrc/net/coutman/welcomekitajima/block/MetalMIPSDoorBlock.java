...
public class MetalMIPSDoorBlock extends DoorBlock {
	public static AbstractBlock.Settings PROPERTIES = AbstractBlock.Settings.create().sounds(BlockSoundGroup.METAL).strength(1.5f, 15f).nonOpaque().solidBlock((bs, br, bp) -> false);
	...
	public static void clientInit() {
		BlockRenderLayerMap.INSTANCE.putBlock(WelcomekitajimaModBlocks.METAL_MIPS_DOOR, RenderLayer.getSolid());
	}
}

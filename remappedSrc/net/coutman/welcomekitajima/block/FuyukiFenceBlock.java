...
public class FuyukiFenceBlock extends FenceBlock {
	...
	public static void clientInit() {
		BlockRenderLayerMap.INSTANCE.putBlock(WelcomekitajimaModBlocks.FUYUKI_FENCE, RenderLayer.getSolid());
	}
}

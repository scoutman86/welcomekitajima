...
public class FuyukiLeavesBlock extends LeavesBlock {
	public static AbstractBlock.Settings PROPERTIES = AbstractBlock.Settings.create().burnable().sounds(BlockSoundGroup.GRASS).strength(0.2f).nonOpaque();
	...
	public static void clientInit() {
		BlockRenderLayerMap.INSTANCE.putBlock(WelcomekitajimaModBlocks.FUYUKI_LEAVES, RenderLayer.getSolid());
	}
}
